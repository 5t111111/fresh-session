/**
 * Since I am not sure how to publish a module that depends on a package hosted
 * exclusively on deno.land/x to JSR, I plan to remove such dependencies from
 * those modules. To do so, I will extract only the essential type information
 * files from the Fresh modules, make adjustments so they can be used as a
